...
public class IKmReviewWebserviceServiceService extends Service {
    ...
    //http://ekp13.hanergy.com/sys/webservice/kmReviewWebserviceService?wsdl
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://oa.hanergy.com/sys/webservice/kmReviewWebserviceService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(IKmReviewWebserviceServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://oa.hanergy.com/sys/webservice/kmReviewWebserviceService?wsdl");
        }
        WSDL_LOCATION = url;
    }
